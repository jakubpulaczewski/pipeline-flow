...
async def test_run_async_extractor() -> None:
    executor = PluginWrapper(id="async_extractor_id", func=mocks.mock_async_extractor(id='async_extractor_id'))
...
def test_run_transform_load_data() -> None:
    load_transformer = PluginWrapper(id='mock_transform_loader_id', func=mocks.mock_load_transformer(id='mock_transform_loader_id', query="SELECT 1"))
...
def test_create_phase_extract_with_merge_success(mocker, plugin_registry_mock) -> None:
...
def test_create_phase_load(plugin_mock) -> None:
    ...
    assert loader == LoadPhase.model_construct(steps=[PluginWrapper(id='loader_id', func=mocks.mock_loader(id='loader_id'))])
...
def test_create_phase_transform_at_load(plugin_mock) -> None:
    ...
    assert tf_load == TransformLoadPhase.model_construct(
        steps=[PluginWrapper(id='mock_transform_loader_id', func=mocks.mock_load_transformer(id='mock_transform_loader_id', query="SELECT 1"))]
    )
